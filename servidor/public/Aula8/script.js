...
// //as variaveis cor modelo e marca APENAS eistem dentro da variavel carro, possuindo escopo de função apenas
...
let retangulo_3 = new retangulo ('red','blue',3,100,200,20,20);
retangulo_1.desenhe(ctx1);
retangulo_2.desenhe(ctx1);
retangulo_3.desenhe(ctx1);
// desenhe o retangulo 1 no contexto 1
// retangulo_1.desenhe(ctx1)
// retangulo_1.x = 100;
// retangulo_1.desenhe(ctx1)
